...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .related-meta { font-size: 0.78rem; color: var(--text-muted); margin-bottom: 10px; display: flex; align-items: center; gap: 4px; }
  .related-meta .material-icons { font-size: 0.9rem; color: var(--text-muted); }
...
<div class="layout-wrapper">
    ...
    <section class="content-section">
      ...
      <div class="benefits-grid">
        <div class="benefit-item">
          <div class="benefit-icon"><i class="material-icons">create</i></div>
          <div>
        ...
        <div class="benefit-item">
          <div class="benefit-icon"><i class="material-icons">card_giftcard</i></div>
          <div>
        ...
        <div class="benefit-item">
          <div class="benefit-icon"><i class="material-icons">restaurant</i></div>
          <div>
        ...
        <div class="benefit-item">
          <div class="benefit-icon"><i class="material-icons">assignment</i></div>
          <div>
        ...
        <div class="benefit-item">
          <div class="benefit-icon"><i class="material-icons">photo_camera</i></div>
          <div>
        ...
        <div class="benefit-item">
          <div class="benefit-icon"><i class="material-icons">menu_book</i></div>
          <div>
    ...
    <section class="content-section">
      ...
      <div class="lokasi-box">
        ...
        <div class="lokasi-info">
          ...
          <a class="btn-maps" href="https://maps.google.com" target="_blank"><i class="material-icons">explore</i> Lihat di Google Maps</a>
        </div>
      </div>
  ...
  <aside>
    <div class="book-card">
      ...
      <button class="btn-pesan"><i class="material-icons" style="font-size: 1.1rem;">confirmation_number</i> Pesan Sekarang</button>
