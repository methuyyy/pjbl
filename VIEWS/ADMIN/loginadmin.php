...
.brand-logo-fallback svg { width: 32px; height: 32px; color: #fff; }
...
.login-feature-icon svg { width: 17px; height: 17px; }
...
.login-hint strong { color: var(--primary); font-weight: 600; }
    ...
    <div class="form-group">
      ...
      <div class="input-wrap">
        ...
        <button class="pw-toggle" type="button" id="pw-toggle-btn" onclick="togglePw()">
          <svg id="pw-eye-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
        </button>
      </div>
    </div>
